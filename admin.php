...
if (in_array($text, $textadmin, true) || $datain == "admin") {
    ...
    step("home", $from_id);
    if ($userdata['type'] == "x-ui_single" or $userdata['type'] == "MHSanaei-3.2" or $userdata['type'] == "alireza_single") {
...
elseif (preg_match('/sendmessageuser_(\w+)/', $datain, $dataget)) {
    ...
    if (!$marzban_list_get) {
        sendmessage($from_id, $textbotlang['Admin']['managepanel']['errorStatusPanel'], $backadmin, 'HTML');
        return;
    }
    ...
    $typepanel = select("marzban_panel", "*", "name_panel", $user['Processing_value'], "select");
    if ($typepanel['type'] == "x-ui_single" || $typepanel['type'] == "MHSanaei-3.2") {
...
elseif ($text == $textbotlang['keyboard']['hidePanelForUser'] && $adminrulecheck['rule'] == "administrator") {
    ...
    } elseif ($marzban_list_get['type'] == "x-ui_single" || $marzban_list_get['type'] == "MHSanaei-3.2" || $marzban_list_get['type'] == "alireza_single") {
        $datainbound = $text;
    } elseif ($marzban_list_get['type'] == "s_ui") {
