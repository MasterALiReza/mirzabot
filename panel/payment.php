            ...
            <tr>
              ...
              <td data-label="عملیات" class="desktop-text-center">
                <div style="display:flex; gap:4px; align-items: center; justify-content: center;">
                    ...
                    <?php endif; ?>
                    <a href="payment.php?action=delete&id=<?= urlencode($p['id_order']) ?>&_csrf=<?= csrf_token() ?>" class="btn-icon" style="color:var(--no)" title="حذف" onclick="return confirm('آیا از حذف این تراکنش مطمئن هستید؟')">
                        <?= icon('trash', 16) ?>
                    </a>
                </div>
              </td>
