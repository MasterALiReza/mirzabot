...
try {
    ...
    <div class="tbl-wrap dash-users" style="margin: 10px 0; background: var(--sf2); border: 1px solid var(--bd); border-radius: 8px; padding: 8px; box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
        ...
        <table class="tbl-md">
            <thead>
                <tr>
                    <th style="text-align: right; padding: 10px 8px;">کاربر</th>
                    <th style="text-align: right; padding: 10px 8px;">موجودی</th>
                    <th style="text-align: right; padding: 10px 8px;">گروه</th>
            ...
            <tbody>
                <?php foreach ($referrals as $ref):
                    ...
                    <tr style="border-bottom: 1px solid var(--bd);">
                        <td data-label="کاربر" style="text-align: right; padding: 10px 8px; vertical-align: middle;">
                            <div class="dash-unified-content" style="align-items: center; display: flex; gap: 10px; direction: rtl; justify-content: flex-start; width: 100%; min-width: 0;">
                                ...
                                <div style="min-width: 0; display: flex; flex-direction: column; gap: 2px; text-align: right; overflow: hidden;">
                                    <a href="user.php?id=<?= (int)$ref['id'] ?>" class="cm" style="color: var(--text); font-weight: 600; text-decoration: none; max-width: 160px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: inline-block;">
                        ...
                        <td data-label="گروه" style="text-align: right; padding: 10px 8px; vertical-align: middle;">
                            <span class="tag <?= user_role_tag($refAgent) ?>">
                                <?= user_role_label($refAgent) ?>
                            </span>
                        </td>
                        <td data-label="تاریخ" style="text-align: right; color: var(--mute); padding: 10px 8px; vertical-align: middle;">
